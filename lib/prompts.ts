...
export function buildContentSystemPrompt(req: GenerateRequest): string {
  ...
  return [
    ...
    "[HOOKS]",
    "Viết ĐÚNG 5 câu hook mở đầu THẬT MẠNH: đánh trúng tâm lý người xem (tò mò, sợ bỏ lỡ, chạm nỗi đau/khao khát), có sức lôi kéo, dễ lan truyền. Mỗi hook ngắn gọn, đánh số 1–5, mỗi câu một dòng. Đa dạng kiểu (câu hỏi, con số, tuyên bố gây sốc, kể chuyện).",
    "[THANBAI]",
